  ...
  const getSingleProduct = async () => {
    try {
      const { data } = await axios.get(
        `http://localhost:8000/getSubCategorybyId/${params.id}`
      );
      setId(params.id);
      setImage(data.data.image);
      setSubCategoryName(data.data.SubCategoryName);
      setCat(data.data.Cat);
      setSelectedCategory(data.data.selectedCategory);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `http://localhost:8000/updateSubCategorybyId/${id}`,
        formData
      );
      if (data?.success) {
                    ...
                    <div className="card card-secondary">
                      ...
                      <div className="card-body">
                          <div className="form-group">
                            <label htmlFor>SubCategory Image</label>
                            <input
                              type="file"
                          ...
                          <div className="form-group">
                            ...
                            <input
                              ...
                              placeholder="write a SubCategory Name"
                              className="form-control"
                              onChange={(e) => {
