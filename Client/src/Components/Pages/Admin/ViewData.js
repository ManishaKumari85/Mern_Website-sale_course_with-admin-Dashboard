...
const ViewData = () => {
  ...
  const onDelete = async (id) => {
    if (
      ...
      const resp = await axios.delete(`http://localhost:8000/deleteData/${id}`);
                  ...
                  <div className="col-md-12">
                    <div className="card card-secondary">
                      <div className="card-header">
                        <h3 className="card-title">View Course Data</h3>
                      </div>
                      <div className="row">
                            ...
                            <table className="table table-hover text-nowrap table-striped">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col">CourseAmmount</th>
                                  <th scope="col">CourseDetails</th>
