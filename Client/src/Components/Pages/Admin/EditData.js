...
const EditData = () => {
  ...
  const [CourseAmmount, setCourseAmmount] = useState("");
  ...
  const getSingleProduct = async () => {
    try {
      const { data } = await axios.get(
        `http://localhost:8000/getdata/${params.id}`
      );
      setId(params.id);
      setImage(data.data.image);
      setCourseName(data.data.CourseName);
      setCourseDuration(data.data.CourseDuration);
      setCourseAmmount(data.data.CourseAmmount);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("CourseAmmount", CourseAmmount);
      formData.append("CourseDetails", CourseDetails);
      formData.append("Description", Description);
      formData.append("image", image);

      const { data } = await axios.put(
        `http://localhost:8000/updatedata/${id}`,
        formData
      );
      if (data?.success) {
                  ...
                  <div className="col-md-12">
                    <div className="card card-secondary">
                      <div className="card-header">
                        <h3 className="card-title">Edit Course Data</h3>
                      </div>
                        ...
                        <div className="card-body">
                          ...
                          <div className="form-group">
                            ...
                            <input
                              ...
                              className="form-control"
                              onChange={(e) => {
                                setCourseAmmount(e.target.value);
                              }}
                              required
                            />
                          </div>
                          <div className="form-group">
                            ...
                            <input
                              type="text"
                              value={CourseDetails}
                              placeholder="write a Course Details"
                              className="form-control"
                              onChange={(e) => {
