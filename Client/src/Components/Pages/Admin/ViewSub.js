  ...
  const onDelete = async (id) => {
    if (
      ...
      const resp = await axios.delete(
        `http://localhost:8000/deleteSubCategory/${id}`
      );
                  ...
                  <div className="col-md-12">
                    <div className="card card-secondary">
                      <div className="card-header">
                        <h3 className="card-title">View SubCategory Data</h3>
                      </div>
                      <div className="row">
                        <div className="col-12">
                          <div className="card-header">
                            <Link to="/addSub" className="btn btn-success">
                                ...
                                {users.length > 0 ? (
                                  users.map((data, index) => (
                                    <tr>
                                      ...
                                      <td>{data.Cat[0].CategoryName}</td>
                                      <td>{data.Description}</td>
                                      <td>
                                        <Link to={`/editSub/${data._id}`}>
